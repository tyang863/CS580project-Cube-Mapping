...
typedef float GzTriangle[3][6]; //each line is a vertex, the first 3 elements are its coordinates, the last 3 elements are its normal coordinates
...
//Available modes
#define LIGHT_GOURAUD 0
#define LIGHT_PHONG 1
#define REFLECTION 2
#define REFRACTION 3

//Set reflection (0) or refraction (1)
#define MODE 2
//Set skybox file name
#define BOX "desertsky"
...
#define	MAXXRES	4096	/* put some bounds on size in case of error */
#define	MAXYRES	4096
